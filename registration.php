...
move_uploaded_file($rtmp_name,"images/$rname");
	...
	(name, mobile, email, password, city, address,experience, id_proof, id_picture,work_type,subcategory,picture,status) 
	VALUES ('$first','$mobile','$email','$password','$city','$address','$experience','$id_proof','$name','$work','$subcategory','$rname','Not Approved')";
