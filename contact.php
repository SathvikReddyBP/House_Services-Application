        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Indrapuri Bhopal</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">+91 8602768216</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">myemail@gmail.com</a></p>
        ...
        <div class="row">
          <div class="col-md-4">
            <div>
              ...
              <p class="mb-0">Indrapuri <br>  Bhopal</p>
            </div>
          </div>
          <div class="col-md-4">
            <div>
          ...
          <div class="col-md-4">
            ...
            <p class="mb-0">Email: myemail@gmail.com <br>
            Phone: +91 8602768216 </p>
          </div>
        </div>
      </div>
    </div>
